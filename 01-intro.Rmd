...
```{r agec-lci-emissions,echo=FALSE,out.width="95%",fig.align='center',fig.cap="Emissions Computed by AGEC-LCI"}
knitr::include_graphics("Figures/agec_lci_emissions.png")
```
